...
companies = utils.Domains(
    body="Привет! В ОЛего тебе нужно построить собственную компанию с нуля. Меня часто спрашивают: 'С чего ты начинал?' С воли к жизни. Жить я хотел, а не прозябать. Давай создадим твою компанию. Чем она будет заниматься?\n",
